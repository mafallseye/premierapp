  ...
  <div class="home">
    ...
    <section>
      ...
      >
        ...
        <p
          class="mb-5 ml-40 mr-40 p-10 text-base text-gray-500 sm:text-lg dark:text-gray-400"
        >
    ...
    <section class="teal">
      <div
        class="p-4 bg-green-400 w-full text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700"
      >
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
          <div class="max-w-screen-md mb-8 lg:mb-16">
            <p class="text-gray-500 sm:text-xl dark:text-gray-400">
              Voici quelques uns des projets que je suis fiere de vous présenter
              :
            </p>
          </div>
          <div
