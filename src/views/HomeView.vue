<template>
  <div class="home">
    ...
    <section>
      ...
      >
        <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white teal">
        Je me présente,
        </h5>
        <p class="mb-5   ml-40 mr-40  p-10 text-base text-gray-500 sm:text-lg dark:text-gray-400">
        Je m'appelle Maguette fall SEYE, spécialisée en developpement web et mobile.Passionnée en informatique surtout dans le domaine de 
        developpement web et mobile je me suis également spécialisée en réseau informatique .Je travail dans le domain de developpement web(fullStack) et mobile dépuis 4 ans 
...
<div class="p-4 bg-gray-100 w-full text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">

    <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Bon passons aux choses sérieuses</p>
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          ...
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">Voici quelques uns des projets que je suis fiere de vous présenter :</p>
      </div>
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
                ...
                <ul class="text-white dark:text-white">
                    <li class="mb-4">
                        <a href="https://github.com/maguette-fall-seye" class="hover:underline ">Github</a>
                    </li>
                    <li>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <a href="#" class="text-white hover:text-gray-900 dark:hover:text-white">
                ...
                <span class="sr-only"> <a href="https://github.com/maguette-fall-seye"> GitHub account</a></span>
            </a>
            <a href="#" class="text-white hover:text-gray-900 dark:hover:text-white">
