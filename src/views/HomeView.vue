  ...
  <div class="home">
    ...
    <section>
      ...
      >
        ...
        developpement web et mobile je me suis également spécialisée en réseau informatique . 
...
<div class="p-4 bg-gray-100 w-full text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">phase d'introduction aux projets</h5>
